...
// マクロ定義
//*****************************************************************************
#define MAX_SELECTMENU			(3)							//ランキングの数
...
public:
	...
	~CSelectMenu();
	static CSelectMenu *Create(D3DXVECTOR3 pos, float fLength, MENU_TYPE type);
	...
	static void MenuDecide(SELECT_MENU MenuSelect);
	//メンバ変数
private:
